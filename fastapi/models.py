...
class Client(Base):
    ...
    # Establish a one-to-many relationship with the 'statement' table
    statement: Mapped[list['Transaction']] = relationship(back_populates='client')
...
class Transaction(Base):
    ...
    client: Mapped['Client'] = relationship(back_populates='statement')
